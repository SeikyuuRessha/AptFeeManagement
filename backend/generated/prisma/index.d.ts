...
export namespace Prisma {
  ...
  */
  ...
  export type ResidentOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "createdAt" | "updatedAt" | "fullName" | "email" | "password" | "phone" | "refreshToken" | "role", ExtArgs["result"]["resident"]>
  ...
  interface ResidentFieldRefs {
    ...
    readonly role: FieldRef<"Resident", 'String'>
  }
  ...
  export type ResidentWhereInput = {
    ...
    role?: StringFilter<"Resident"> | string
    apartments?: ApartmentListRelationFilter
  ...
  export type ResidentScalarWhereWithAggregatesInput = {
    ...
    role?: StringWithAggregatesFilter<"Resident"> | string
  }
